"""cashed_21693 URL Configuration
...
admin.site.site_header = "Cashed"
admin.site.site_title = "Cashed Admin Portal"
admin.site.index_title = "Cashed Admin"

# swagger
api_info = openapi.Info(
    title="Cashed API",
    default_version="v1",
    description="API documentation for Cashed App",
)
